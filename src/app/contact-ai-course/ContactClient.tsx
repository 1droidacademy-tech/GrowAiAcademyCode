      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-8 flex flex-col">
            ...
            <div className="bg-[#F8FAFC] p-8 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col md:flex-row gap-8 justify-between items-start md:items-center">
              <div className="flex flex-col gap-6">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    <div className="text-xs font-bold text-slate-500 uppercase tracking-widest">WhatsApp Only</div>
                    <a 
                      href="https://wa.me/917806918011?text=Hi%20I%20need%20to%20know%20more%20details%20on%20GrowAiEdu" 
                      target="_blank" 
            ...
            {/* Map Block */}
            <a href="https://maps.app.goo.gl/mgbKP2YtqdvWU7iC6" target="_blank" rel="noopener noreferrer" className="relative flex-grow min-h-[220px] rounded-[2rem] overflow-hidden group block">
              ...
              <div className="absolute top-6 left-6 right-6">
                <div className="bg-white/90 backdrop-blur-md px-6 py-4 rounded-2xl shadow-lg border border-white/20 flex justify-between items-center">
                  <div>
                    ...
                    <div className="font-semibold text-slate-800">GrowAiEdu Academy</div>
                  </div>
                  <div className="w-10 h-10 bg-indigo-500 rounded-full flex items-center justify-center text-white shadow-md shadow-indigo-500/40 transition-transform group-hover:scale-110">
